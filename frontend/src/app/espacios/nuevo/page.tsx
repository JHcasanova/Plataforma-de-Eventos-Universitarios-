...
import { TipoEspacio } from '@/lib/types';

// Opciones del enum TipoEspacio
const tiposEspacio: TipoEspacio[] = ['AULA', 'AUDITORIO', 'LABORATORIO', 'CANCHA', 'OTRO'];

export default function PaginaNuevoEspacio() {
  ...
  return (
    <div className="max-w-lg">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Nuevo Espacio</h2>
